package com.lingjiancong.mongodb.morphia;
...
/**
 * This class is used in the Quick Tour documentation and is used to demonstrate various Morphia
 * features.
 *
 * @author lingjiancong
 */
public final class QuickTour {
    ...
    public static void main(final String[] args) throws UnknownHostException {
        ...
        morphia.mapPackage("com.ling.mongodb.morphia");
